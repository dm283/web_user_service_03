  ...
  <div class="">
    <div class="inline-block mt-5 ml-5">
      <RouterLink to="/add_cert_goods_accept">
        <CatalogSection :label="'Создать акт приёма'" :icon="'file-plus'" :description="'Создание нового акта'" />
      </RouterLink>
    </div>
    <div class="inline-block mt-5 ml-5">
      <RouterLink to="/certs_goods_accept">
        <CatalogSection :label="'Принятые партии товаров'" :icon="'shopping-bag'" :description="'Акты приёма товаров на склад'" />
      </RouterLink>
    </div>
    <div class="inline-block mt-5 ml-5">
